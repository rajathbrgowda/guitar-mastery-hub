    ...
    <Box sx={{ maxWidth: 600, mx: 'auto' }}>
      ...
      {profileFailed && (
        <Alert severity="warning" sx={{ mb: 2 }}>
          Could not load your profile — changes may not save correctly.
        </Alert>
      )}

      {/* ── Profile ───────────────────────────────────────────────────── */}
      <Card sx={{ mb: 2 }}>
        <CardContent sx={{ px: { xs: 1.5, sm: 2 }, py: 2, '&:last-child': { pb: 2 } }}>
          <Typography variant="overline" color="text.secondary">
            Profile
          </Typography>

          {/* Avatar inline with display name — no more duplicate name row */}
          ...
          {/* Guitar type + years on one row on sm+ */}
          <Box
            sx={{
              display: 'flex',
              gap: 2,
          ...
          {profileMsg && (
            <Alert severity={profileMsg.type} sx={{ mt: 1.5 }}>
              {profileMsg.text}
            </Alert>
          )}
          ...
          <Button
            ...
            startIcon={savingProfile ? <CircularProgress size={14} color="inherit" /> : null}
            sx={{ mt: 1.5 }}
          >
      ...
      <Card sx={{ mb: 2 }}>
        <CardContent sx={{ px: { xs: 1.5, sm: 2 }, py: 2, '&:last-child': { pb: 2 } }}>
          ...
          <Slider
            ...
            sx={{ color: 'primary.main', mt: 0.5, mb: 2 }}
          />
          ...
          >
            ...
            <Typography variant="caption" color="text.secondary">
              {practiceDays} day{practiceDays !== 1 ? 's' : ''}
            </Typography>
          </Box>
          <ToggleButtonGroup
            value={practiceDays}
          ...
          {goalsMsg && (
            <Alert severity={goalsMsg.type} sx={{ mt: 1.5 }}>
              {goalsMsg.text}
            </Alert>
          )}
          ...
          <Button
            ...
            startIcon={savingGoals ? <CircularProgress size={14} color="inherit" /> : null}
            sx={{ mt: 1.5 }}
          >
        ...
        <CardContent sx={{ px: { xs: 1.5, sm: 2 }, py: 2, '&:last-child': { pb: 2 } }}>
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
            <Button
              variant="outlined"
              size="small"
              startIcon={exporting ? <CircularProgress size={12} /> : <DownloadOutlinedIcon />}
      ...
      <Card sx={{ mb: 2 }}>
        <CardContent sx={{ px: { xs: 1.5, sm: 2 }, py: 2, '&:last-child': { pb: 2 } }}>
          ...
          >
            ...
            <Typography variant="caption" color="text.secondary">
              Progress tracked independently per curriculum
            </Typography>
          </Box>
          <CurriculumPicker
            compact
      ...
      <Card sx={{ border: '1px solid', borderColor: 'error.light' }}>
        <CardContent sx={{ px: { xs: 1.5, sm: 2 }, py: 1.5, '&:last-child': { pb: 1.5 } }}>
          {resetMsg && (
            <Alert severity={resetMsg.type} sx={{ mb: 1.5 }}>
              {resetMsg.text}
            </Alert>
          )}
